...
SELECT bank_name from bank_details where bank_id=( SELECT b_id FROM cust_details  where cust_id =201);
SELECT bank_name from bank_details where bank_id=( SELECT b_id FROM cust_details  where cust_id =202);
SELECT place from bank_details where bank_id=( SELECT b_id FROM cust_details  where cust_id =201);
SELECT place from bank_details where bank_id=( SELECT b_id FROM cust_details  where c_balance =3000);
